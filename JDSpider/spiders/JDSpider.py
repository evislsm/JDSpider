...
import json
import requests
from JDSpider.scrapy_redis.spiders import RedisSpider
...
class JDSpider(RedisSpider):
    ...
    def parse(self, response):
        ...
        for text in texts:
            ...
            yield scrapy.Request(url='https:' + items[0], callback=self.parse_product, meta=meta)
            #print(items)
        # 测试
        # print('2')
        ...
        if next_list:
            ...
            yield scrapy.Request(url=Base_url + next_list[0], callback=self.parse)
